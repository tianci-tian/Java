...
public final class CardReader {
  ...
  public List<ResponseAPDU> getResponse(CardTerminal terminal,
      List<CommandAPDU> commands) {
  ...
  public Card ReaderConnect(CardTerminal terminal) throws CardException {
    Card card = terminal.connect("T=0");
    return card;
  }

  public ResponseAPDU getOneCmdResponse(Card card, CommandAPDU command) {
  ...
  public void ReaderDisConnect(Card card) throws CardException {
    // disconnect
    card.disconnect(false);
  }
